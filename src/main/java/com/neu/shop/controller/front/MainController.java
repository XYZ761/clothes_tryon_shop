...
public class MainController {
    ...
    public String showAllGoods(Model model, HttpSession session) {
        ...
        //数码分类
        List<Goods> digGoods = getCateGoods("女装", userid);
        model.addAttribute("digGoods", digGoods);

        //家电
        List<Goods> houseGoods = getCateGoods("男装", userid);
        ...
        //书籍
        List<Goods> bookGoods = getCateGoods("婴儿装", userid);
