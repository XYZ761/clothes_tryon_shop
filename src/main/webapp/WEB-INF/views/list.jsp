    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabelPsw">服装评价</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" id="updatePsw-form" name="update-form" method="post">
                    <div class="form-group">
                        <label for="star" class="col-sm-2 control-label">服装评分</label>
                        <div class="col-sm-9">
                    ...
                    <c:if test="${!order.issend}">
                        <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid"
                            ...
                            <div class="tab-content col-lg-12">
                                ...
                                <table class="table " cellpadding="6" cellspacing="1"><%--服装描述--%>
                                    <tbody>
                                ...
                                <c:forEach items="${order.goodsInfo}" var="good">
                                    <table class="table table-bordered" cellpadding="6" cellspacing="1"><%--服装信息--%>
                                        ...
                                        <tr>
                                            ...
                                            <td class="col-lg-1">
                                                    <%--${good.ispay}--%>
                                                    <%--<button class="templatemo-blue-button finish-btn" name="deleteList"><h5>付款</h5></button>--%>


                                                    <%--<button id=""--%>
                                                    <%--class="button_act button_act-tc confirm-orders center-block">付款--%>
                                                    <%--</button>--%>

                                                    <%--<button id="pay" type="button" class="btn btn-danger center-block">付款</button>--%>

                                                    <%--<button id="h" onclick="aaa()" class="btn btn-danger center-block">付款</button>--%>
                                                    <%--<script>function aaa(){document.getElementById("h").innerHTML="已付款";}</script>--%>
                                                ...
                                                <c:if test="${order.ispay==false}">
                                                    <button name="pay" type="button" class="btn btn-danger center-block">
                                                        付款
                                                    </button>
                                                </c:if>
