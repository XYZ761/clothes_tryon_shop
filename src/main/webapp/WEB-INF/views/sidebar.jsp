...
<div class="templatemo-sidebar">
    ...
    <nav class="templatemo-left-nav">
        <ul>
            ...
            <li><a href="${pageContext.request.contextPath}/admin/goods/show"><i class="fa fa-bar-chart fa-fw"></i>服装管理</a></li>
            <li><a href="${pageContext.request.contextPath}/admin/order/send"><i class="fa fa-users fa-fw"></i>试穿管理</a></li>
            <%--<li><a href="${pageContext.request.contextPath}/admin/order/send"><i class="fa fa-database fa-fw"></i>试穿管理</a></li>--%>
