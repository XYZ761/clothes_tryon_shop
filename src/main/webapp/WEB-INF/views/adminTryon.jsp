...
<head>
    ...
    <!-- Templatemo Script -->
    <script src="${pageContext.request.contextPath}/js/adminTryon.js"></script>
    ...
    <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
                            ...
                            <div class="panel-body">
                                <div>
                                    ...
                                    <div class="goods-info margin-bottom-10">
                                        <div class="head-div">服装信息</div>
                                        <div>
                                            <table id="goodsinfo" class="table table-striped table-bordered templatemo-user-table goods-table">
                                                <thead>
                                                <tr>
                                                    <td><a href="" class="white-text templatemo-sort-by">服装id<span
                                                            class="caret"></span></a></td>
                                                    <td><a href="" class="white-text templatemo-sort-by">服装名<span class="caret"></span></a>
                                                    </td>
                                                    ...
                                                    <td><a href="" class="white-text templatemo-sort-by">数量<span
                                                        ...
                                                        <%--class="caret"></span></a></td>--%>
                                                    <td>详情</td>
                                                    <td><a href="" class="white-text templatemo-sort-by">未付款<span
                                                            class="caret"></span></a></td>
                                                    <%--<td><a href="" class="white-text templatemo-sort-by">退货<span--%>
                                                            <%--class="caret"></span></a></td>--%>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                <c:forEach items="${orderInfo.goodsInfo}" var="goods">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><button name="<%--adminpay--%>" type="button" class="btn btn-default center-block" >
                                                            未付款
                                                        </button></td>
                                                        <%--<td><button name="adminreject" type="button" class="btn btn-default center-block">--%>
                                                            <%--退货--%>
                                                        <%--</button></td>--%>
                                                            <%--<td>
                                    ...
                                    <%--<div class="margin-bottom-10">--%>
                                        <%--<a href="${pageContext.request.contextPath}/admin/order/sendGoods?orderid=${orderInfo.orderid}" class="templatemo-edit-btn pull-right">已付款</a>--%>
                                    <%--</div>--%>
                                </div>
                            </div>
                        </div>
            ...
            <div class="pagination-wrap" id="page-div-nav">
                ...
                <ul class="pagination">
                    <li>
                        <a href="${pageContext.request.contextPath}/admin/order/tryon?page=1" aria-label="Next">
                    ...
                    <c:if test="${pageInfo.hasPreviousPage}">
                        <li>
                            <a href="${pageContext.request.contextPath}/admin/order/tryon?page=${pageInfo.pageNum - 1}" aria-label="Previous">
                    ...
                    <c:forEach items="${pageInfo.navigatepageNums}" var="pageNums">
                        <c:if test="${pageNums == pageInfo.pageNum}">
                            <li class="active"><a href="${pageContext.request.contextPath}/admin/order/tryon?page=${pageNums}">${pageNums}</a></li>
                        </c:if>
                        <c:if test="${pageNums != pageInfo.pageNum}">
                            <li><a href="${pageContext.request.contextPath}/admin/order/tryon?page=${pageNums}">${pageNums}</a></li>
                        </c:if>
                    </c:forEach>

                    <c:if test="${pageInfo.hasNextPage}">
                        <li>
                            <a href="${pageContext.request.contextPath}/admin/order/tryon?page=${pageInfo.pageNum + 1}" aria-label="Next">
                                <span aria-hidden="true"><i class="fa fa-forward"></i></span>
                            </a>
                        </li>
                    </c:if>
                    <li>
                        <a href="${pageContext.request.contextPath}/admin/order/tryon?page=${pageInfo.pages}" aria-label="Next">
