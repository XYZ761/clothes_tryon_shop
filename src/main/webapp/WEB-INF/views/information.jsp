            ...
            <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid">
                <div class="tab-content">
                        <table class="table" cellpadding="6" cellspacing="1">
                            ...
                            <tr>
                                <th style="border: 0px solid transparent" class="tl">等级</th>
                                <td style="border: 0px solid transparent" class="tr" id="levelVal">
                                    <c:if test="${user.getLevel()==0}">普通会员</c:if>
                                    <c:if test="${user.getLevel()==1}">黄金会员</c:if>
                                    <c:if test="${user.getLevel()==2}">铂金会员</c:if>
                                    <c:if test="${user.getLevel()==3}">钻石会员</c:if>
                                    <%--${user.getLevel()}--%>
